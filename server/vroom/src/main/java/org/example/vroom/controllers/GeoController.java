...
public class GeoController {
    ...
    public ResponseEntity<List<AddressSuggestionResponseDTO>> autocompleteAddress(@RequestParam @NotBlank String location) {
        try{
    ...
    public ResponseEntity<AddressSuggestionResponseDTO> geocodeLocation(@RequestParam @NotBlank String location) {
        try{
